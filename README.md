...
Mapa estelar 3D interativo (90 corpos, 20 sistemas, 6 galáxias) em HTML único + Three.js, sem build.
...
No celular, os mesmos recursos estão nos botões ◉ (foto, ou toque longo na tela) e ◈ (registro de bordo).
