...
terra: {
  ...
  sections: [
    ...
    {t:'THE METEOR SHOWERS', rows:[['What it is','Every shooting star of a shower is a grain of comet (or asteroid) burning 80 km up: Earth crosses the same stream of dust every year, on the same date'],['Quadrantids · JAN 3','Short and intense, up to 120 per hour; the parent is asteroid 2003 EH1, probably an extinct comet'],['Lyrids · APR 22','The oldest recorded shower (687 BC); dust of comet Thatcher, which only returns in 2276'],['Eta Aquariids · MAY 6','The grains of Halley, fast (66 km/s), best from the southern hemisphere before dawn'],['Perseids · AUG 12','The most famous: some 100 per hour, dust of Swift-Tuttle, the Tears of Saint Lawrence'],['Draconids · OCT 8','Slow and treacherous: almost nothing most years, storms in 1933 and 1946; dust of Giacobini-Zinner'],['Orionids · OCT 21','The second visit of Halley in the year, out of the raised arm of Orion'],['Taurids · NOV 12','Few, but with slow fireballs: the wide stream of Encke'],['Leonids · NOV 17','Storms every 33 years (1833, 1966, 1999): fresh dust of Tempel-Tuttle'],['Geminids · DEC 14','The richest, some 120 per hour and colorful; the parent is asteroid Phaethon, the rock comet'],['Ursids · DEC 22','The last of the year, discreet, near the north celestial pole: dust of Tuttle']]}
  ],
...
fobos: {
  ...
  sections: [
    ...
    {t:'MMX', rows:[['The mission','Martian Moons eXploration, by JAXA: the first probe to LAND on Phobos and bring a sample back, with the IDEFIX rover (France and Germany) and a NASA spectrometer aboard'],['The launch','Planned for late 2026 on an H3 rocket, from Tanegashima; it reaches Mars in 2027 and spends three years in a quasi-synchronous orbit with Phobos, a few tens of km above the surface'],['The sampling','Two short landings, a few hours each, with a corer that digs 2 cm and collects at least 10 g; the 25 kg IDEFIX rover is dropped beforehand to see the ground up close'],['The question','Is Phobos a captured asteroid or a piece of Mars blasted off by an impact? The sample answers: ice and carbon say asteroid, Martian minerals say impact'],['The return','Deimos flybys on the way and the capsule landing on Earth in 2031: the second sample of a moon, after our own'],['The bonus','An 8K camera (with NHK) and three years watching the weather of Mars from above: the wind, the dust and the clouds']]}
  ],
...
iss: {
  ...
  sections: [
    ...
    {t:'THE MODULES', rows:[['Zarya (1998)','The first: the Russian cargo and power block, launched on a Proton, which kicked off the assembly'],['Unity (1998)','The American node that joined the two sides, brought by the shuttle Endeavour two weeks later'],['Zvezda (2000)','The Russian service module: quarters, engines and the control of the station; it is what allowed the first crew'],['Destiny (2001)','The American laboratory, the scientific heart of the western side'],['Kibo (2008-09)','The Japanese laboratory, the largest module of the station, with the porch exposed to vacuum'],['Columbus (2008)','The European laboratory, brought by Atlantis'],['The Cupola (2010)','The seven windows where almost every photo of the Earth taken from there comes from'],['Nauka (2021)','The last large Russian module, 14 years late, and the European robotic arm']]},
    {t:'THE RETIREMENT', rows:[['The date','NASA and the partners keep the station until 2030; Russia has confirmed until 2028'],['How it ends','A SpaceX deorbit vehicle, contracted in 2024 for 843 million dollars, will push it into a controlled reentry over the South Pacific, far from everything, at Point Nemo'],['What comes next','Commercial stations (Axiom, Vast, Starlab) and the Lunar Gateway around the Moon'],['The legacy','More than 3,000 experiments and 280 people from 23 countries in a quarter century']]},
...
halley: {
  ...
  sections: [
    {t:'THE PASSAGES', rows:[['240 BC','The oldest certain record, in the Chinese chronicles; Babylon noted the passage of 164 BC on clay tablets'],['1066','It passes months before the Battle of Hastings and the Bayeux Tapestry embroiders it as an omen, with the caption isti mirant stella'],['1301','Giotto sees it and paints it as the Star of Bethlehem in the Adoration of the Magi at the Scrovegni Chapel, in Padua'],['1682','Edmond Halley observes it and in 1705 proves it is the same comet as 1531 and 1607: the return predicted for 1758 comes true, and the comet takes his name'],['1910','The Earth crosses the tail; the press talks of poisonous cyanogen and anti-comet pills and masks are sold; Mark Twain, born at the 1835 passage, dies one day after perihelion'],['1986','The most studied passage and the least pretty to the naked eye: five probes visit it, and Giotto photographs the peanut-shaped nucleus from 600 km']]},
...
ponsbrooks: {
  kind: 'The devil comet of 2024, the one with the horns',
  quick: [['NUCLEUS','~30 km'],['PERIOD','71 years'],['LAST VISIT','APR 21, 2024'],['NEXT','2095'],['INCLINATION','74 degrees'],['DISCOVERED','1812']],
  sections: [
    {t:'THE DEVIL COMET', rows:[['The outbursts','On July 20, 2023, at 3.9 AU from the Sun, the brightness rose a hundredfold in one night and the coma opened into two horns: the photo went around the world as the devil comet (or the Millennium Falcon)'],['The cause','Cryovolcanism: pockets of ice under pressure that burst and throw out gas and dust; the shadow of the nucleus itself on the cloud draws the horns'],['The repeat','More outbursts in October, November and December 2023, each one redrawing the horns for a few days'],['An old acquaintance','In 1883 it also erupted several times on approach: that is its way']]},
    {t:'THE RETURN OF 2024', rows:[['The perihelion','April 21, 2024, at 0.78 AU from the Sun, between the orbits of Venus and Earth'],['The eclipse','On April 8, 2024, during the total eclipse over the United States and Mexico, it sat 25 degrees from the hidden Sun and showed up in the photos of totality'],['The brightness','It reached about magnitude 4, low in the northwest twilight in March and April, with the blue ion tail'],['The south','After perihelion it dived into the southern sky, closest to Earth on June 2, at 1.55 AU']]},
    {t:'RECORD', rows:[['1812','Discovered on July 12 by Jean-Louis Pons, in Marseille, the greatest comet hunter in history, with 37 discoveries'],['1883','Recovered by William Brooks, in New York, when nobody expected it: the two passages linked by calculation, and the double name'],['The type','A Halley-type comet: 71-year period, an upright orbit (74 degrees) and one of the largest known nuclei, some 30 km'],['Here on the map','JPL elements at the epoch of 2024; the scenic map compresses the ellipse']]}
  ],
  facts: ['In July 2023 it erupted and grew two horns of gas: it became the devil comet of the photos.', 'It returns every 71 years on an upright orbit; the last passage was in April 2024, next to the eclipsed Sun.', 'Jean-Louis Pons, who found it in 1812, discovered 37 comets: the all-time naked-eye record.'],
  fict: 'The nickname devil comet came from the two horns of the coma; the internet preferred to call it the Millennium Falcon, and both photos are the same outburst.'
},
atlasg3: {
  kind: 'The brightest of 2025: seen in daylight, undone on the way out',
  quick: [['NUCLEUS','small, disintegrated'],['PERIHELION','JAN 13, 2025 · 0.094 AU'],['BRIGHTNESS','magnitude −3.5, in daylight'],['DISCOVERED','APR 5, 2024'],['INCLINATION','117° · retrograde'],['PREVIOUS VISIT','~160,000 years ago']],
  sections: [
    {t:'THE GREAT COMET OF 2025', rows:[['The perihelion','January 13, 2025, at 0.094 AU from the Sun, closer than Mercury: the surface of the nucleus passed 400 degrees'],['In daylight','It reached magnitude −3.5, brighter than Jupiter: in the days around perihelion it could be seen in daylight, a few degrees from the Sun, with a hand covering the disk'],['SOHO','The coronagraph of the SOHO satellite filmed it crossing the field with the whole tail, as only happens with sungrazers'],['The southern hemisphere','From the second half of January the southern twilight (Chile, Australia, Brazil) got a dust tail of more than 20 degrees, fanned out, streaked by the synchrones of each dust outburst']]},
    {t:'THE END', rows:[['The death','Around January 19 and 20, 2025 the central condensation vanished and the head grew elongated: the nucleus fell apart on the way out, cooked by the grazing passage'],['The ghost','The tail stayed visible for weeks, headless: a comet without a comet, like Lovejoy in 2011'],['The orbit','Inclined 117 degrees, retrograde; the previous visit was some 160,000 years ago, and the exit came out slightly hyperbolic: what is left will not return'],['From the ISS','Astronaut Don Pettit photographed the tail rising over the limb of the Earth, from the Space Station, in January 2025']]},
    {t:'RECORD', rows:[['APR 5, 2024','Discovered by ATLAS (Asteroid Terrestrial-impact Last Alert System) at Rio Hurtado, Chile, 4.4 AU from the Sun'],['The bet','A sungrazer with perihelion at 0.09 AU: either it shines a lot or it falls apart; it did both'],['Here on the map','The hyperbola with the real perihelion; the position of today by the parabolic calculation']]}
  ],
